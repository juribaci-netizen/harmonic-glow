...
export const translations = {
  sk: {
    appName: "Worktime", orchestra: "Slovenská filharmónia",
    ...
    dashboard: "Prehľad", schedule: "Rozvrh", timesheet: "Výkaz práce", videos: "Videá koncertov", profile: "Profil",
    ...
    seasonSchedule: "Sezónny rozvrh", seasonSubtitle: "Pracovný plán orchestra na sezónu 2026/2027", seedSeason: "Načítať sezónny plán", seeding: "Načítavam...", logHours: "Zaznamenať hodiny", logged2: "Zaznamenané", allTypes: "Všetky typy",
    monthlyRecord: "Mesačný výkaz", timesheetSubtitle: "Evidencia odpracovaných hodín podľa mesiacov", totalHours: "Spolu hodín", date: "Dátum", activity: "Aktivita", type: "Typ", hours: "Hodiny", status: "Stav", actions: "Akcie", noRecords: "Žiadne záznamy pre tento mesiac", export: "Exportovať",
    concertVideos: "Videá koncertov", videosSubtitle: "Archív nahrávok a záznamov z koncertov", watch: "Pozrieť", noVideos: "Zatiaľ žiadne videá", addVideo: "Pridať video",
    myProfile: "Môj profil", profileSubtitle: "Spravujte svoje osobné a orchestrálne údaje", fullName: "Meno a priezvisko", instrument: "Nástroj", section: "Sekcia", position: "Pozícia", phone: "Telefón", save: "Uložiť", saving: "Ukladám...", saved: "Uložené",
  ...
  en: {
    ...
    myProfile: "My profile", profileSubtitle: "Manage your personal and orchestral details", fullName: "Full name", instrument: "Instrument", section: "Section", position: "Position", phone: "Phone", save: "Save", saving: "Saving...", saved: "Saved",
