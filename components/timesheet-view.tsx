  ...
  return <div className="space-y-5">
    ...
    <section className="rounded-[22px] border border-black/10 bg-white">
      ...
      <div className="space-y-3 p-3">
        <p className="text-xs leading-relaxed text-black/60">X sa zapíše po skončení služby iba pri potvrdenom Hrám v pláne práce. Pri Nehrám alebo nevybranej účasti zostávajú iba časy IP. Ručné opravy X sú výnimkou pre konkrétnu službu.</p>
